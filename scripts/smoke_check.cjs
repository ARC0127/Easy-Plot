  ...
  project: {
    ...
    objects: {
      panel_1: {
        ...
        transform: { translate: [0,0], scale: [1,1], rotate: 0 }, styleRef: null,
        ...
        stability: { exportStabilityClass: 'stable', requiresSnapshotRendering: false, reimportExpectation: 'semantic', equivalenceTarget: 'EQ-L2' },
        manualEdits: [], label: 'a', titleObjectId: null, layoutRole: 'plot_panel',
      ...
      legend_1: {
        ...
        bbox: { x: 10, y: 10, w: 40, h: 20 }, transform: { translate: [0,0], scale: [1,1], rotate: 0 }, styleRef: null,
        ...
        stability: { exportStabilityClass: 'stable', requiresSnapshotRendering: false, reimportExpectation: 'semantic', equivalenceTarget: 'EQ-L2' },
        manualEdits: [], itemObjectIds: [], anchor: { kind: 'panel_anchor', value: 'top_right', targetPanelId: 'panel_1' }, offset: [0,0], orientation: 'vertical', floating: true
      },
      text_1: {
        id: 'text_1', objectType: 'text_node', name: 'Title', visible: true, locked: false, zIndex: 3,
        bbox: { x: 0, y: 0, w: 50, h: 10 }, transform: { translate: [0,0], scale: [1,1], rotate: 0 }, styleRef: null,
        ...
        stability: { exportStabilityClass: 'stable', requiresSnapshotRendering: false, reimportExpectation: 'semantic', equivalenceTarget: 'EQ-L2' },
        manualEdits: [], textKind: 'raw_text', content: 'Hello', position: [0,0],
