...
exports.collectInlineStyles = collectInlineStyles;
function collectInlineStyles(styleValue) {
    if (!styleValue)
        return {};
    const declarations = [];
    let quote = null;
    ...
    return declarations.reduce((acc, part) => {
        let quoteState = null;
        let parenState = 0;
        let sep = -1;
