...
function uniqueByNodeId(hints: AdapterHint[]): AdapterHint[] {
  const seen = new Set<string>();
  const out: AdapterHint[] = [];
...
export function detectStaticHtmlInlineSvgHints(normalized: NormalizedDocument): AdapterHint[] {
