import type { AnyObject, CapabilityFlag, Project } from '../index';
...
const ALLOWED_CAPABILITIES: Record<AnyObject['objectType'], CapabilityFlag[]> = {
...
export function validateCapabilityConflicts(project: Project): CapabilityIssue[] {
